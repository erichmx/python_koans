...
class AboutDictionaries(Koan):
    ...
    def test_making_a_dictionary_from_a_sequence_of_keys2(self):
        cards = {}.fromkeys(('red warrior', 'green elf', 'blue valkyrie', 'yellow dwarf', 'confused looking zebra'), (1,2,3,4,5))

        self.assertEqual(5, len(cards))
        self.assertEqual((1,2,3,4,5), cards['green elf'])
        self.assertEqual((1,2,3,4,5), cards['yellow dwarf'])
