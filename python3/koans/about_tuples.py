...
class AboutTuples(Koan):
    ...
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        self.assertRegex(msg, "'tuple' \w+ does not support item assignment")
    ...
    def test_tuple_constructor_can_be_surprising(self):
        self.assertEqual(('S', 'u', 'r', 'p', 'r', 'i', 's', 'e', '!'), tuple("Surprise!")) #Not so much of a surprise, strings behave a lot like arrays
